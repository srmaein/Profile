/**
 * Portfolio CMS Admin — Complete Admin Dashboard
 * Features: Auth, Projects CRUD, Categories, Analytics, Image Upload
 */
'use strict';
...
/* ═══════════════════════════════════════════════
   VISITOR TRACKING (Public side)
═══════════════════════════════════════════════ */
async function trackVisitor() {
  // Only track on the public site (not admin)
